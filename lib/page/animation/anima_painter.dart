...
class AnimaPainter extends CustomPainter {
  ...
  AnimaPainter(this.points) : super(repaint: points);
  ...
  void _drawScale(Canvas canvas, Size size) {
    ...
    for (int i = 1; i <= 10; i++) {
      ...
      textPainter.text = TextSpan(text: '${i / 10}', style: TextStyle(fontSize: 12, color: Colors.black));
